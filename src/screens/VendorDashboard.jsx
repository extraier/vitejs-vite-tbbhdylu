...
import {
  ...
  Settings,
  AlertCircle,
  // 2026-08-21 — LogOut removed from imports. The 登出 button
  // used to live in the dark panel removed in this commit;
  // <VendorTopBar> now imports LogOut itself.
  ClipboardList,
  CheckCircle2,
  Circle,
  ChevronDown,
...
export function VendorDashboard({
  ...
  return (
    <div className="max-w-6xl mx-auto mt-8 animate-in slide-in-from-bottom-4 duration-500">
      ...
      {/* 2026-08-21 — removed the dark "商戶接單大堂" panel.
          Its three contents (管理專頁 button, 登出 button, 當前
          登入商戶 identity card) have all been consolidated into
          the sticky <VendorTopBar> at the top of the dashboard.
          Vendors no longer need to scroll down to reach logout
          or manage-profile — both are visible the moment the
          dashboard renders. The identity card (vendor name +
          category) is now the left side of the top bar. */}
